...
/// [RangeSliderWidget] uses this callback to paint the value indicator on the overlay.
...
class RangeSliderWidget extends StatefulWidget {
  ...
  ///
  /// If this property is null, [RangeSliderWidget] will use [activeColor] with
...
class _RangeSliderWidgetState extends State<RangeSliderWidget> with TickerProviderStateMixin {
  ...
  Thumb? _defaultRangeThumbSelector(
    ...
    final double touchRadius = math.max(thumbSize.width, RangeSliderWidget._minTouchTargetWidth) / 2;
...
class _RangeSliderRenderObjectWidget extends LeafRenderObjectWidget {
  ...
  final ValueChanged<RangeValues>? onChangeEnd;
  final SemanticFormatterCallback? semanticFormatterCallback;
  final _RangeSliderWidgetState state;
  final bool hovering;
...
class _RenderRangeSlider extends RenderBox with RelayoutWhenSystemFontsChangeMixin {
  _RenderRangeSlider({
    ...
    required this.onChangeStart,
    required this.onChangeEnd,
    required _RangeSliderWidgetState state,
  ...
  double get _maxSliderPartHeight => _sliderPartSizes.map((Size size) => 0.0).reduce(math.max);
  ...
  final _RangeSliderWidgetState _state;
...
class _RenderValueIndicator extends RenderBox with RelayoutWhenSystemFontsChangeMixin {
  ...
  late Animation<double> _valueIndicatorAnimation;
  late _RangeSliderWidgetState _state;
