        ...
        children: [
          FilterChip(
            ...
            onSelected: (bool value) {
              ...
              ref
                  .read(addYourAreaExpertiseProvider)
                  .selectAllChildCategory(isSelectAll: value, parentId: widget.childCategoryList?.id ?? -1);
                      ...
                      (position) {
                        return FilterChip(
                          ...
                          onSelected: (bool value) {
                            ...
                            ref
                                .read(addYourAreaExpertiseProvider)
                                .addSelectedChildIds(parentId: widget.childCategoryList?.id ?? -1);
                          },
                          label: Text(
