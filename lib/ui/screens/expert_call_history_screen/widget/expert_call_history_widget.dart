  ...
  void initState() {
    ...
    scrollController.addListener(() async {
      if (scrollController.position.pixels == scrollController.position.maxScrollExtent) {
        ...
        if (!isLoading) {
          ref.read(callHistoryProvider).callHistoryApiCall(role: widget.role, showLoader: false, isFromPagination: true);
        } else {
                    ...
                    children: [
                      Padding(
                        ...
                        child: GroupedListView<CallHistoryData, dynamic>(
                          ...
                          groupBy: (element) {
                            print(
                                "check==========================${DateTime(DateTime.parse(element.date ?? '').year, DateTime.parse(element.date ?? '').month, DateTime.parse(element.date ?? '').day).toString().toDisplayMonthWithYear()}");
                          ...
                          itemBuilder: (context, element) {
                            int fees = (element.userDetails?.fee ?? 0) ~/ 100;
                            ...
                            return Container(
                                    ...
                                    decoration: ShapeDecoration(
                                      color: widget.role == 1
                                          ? (element.status?.toString() ?? '').callHistoryStatusUserFromString == CallHistoryUserStatusEnum.incomplete
                                                  ...
                                                  child: Column(
                                                    ...
                                                    children: [
                                                        ...
                                                        children: [
                                                          ...
                                                          Flexible(
                                                            child: Container(
                                                                ...
                                                                decoration: ShapeDecoration(
                                                                  color: element.requestType.toString().getCallHistoryColorFromString,
                                                                  shadows: [
                                                                ...
                                                                child: Padding(
                                                                  ...
                                                                  child: Center(
                                                                    child: BodySmallText(
                                                                      title: element.requestType.toString().getCallHistoryFromString,
                                                                      titleColor: ColorConstants.buttonTextColor,
                                                                      titleTextAlign: TextAlign.center,
                                                      ...
                                                      RichText(
                                                        softWrap: true,
                                                        text: TextSpan(
                                                          text: widget.role == 2 ? LocaleKeys.userWith.tr() : LocaleKeys.expertWith.tr(),
                                                      ...
                                                      RichText(
                                                        text: TextSpan(
                                                          ...
                                                          children: [
                                                            WidgetSpan(child: 2.0.spaceX),
                                                            TextSpan(
                                                                text: durationInMinute > 1
                                                                    ? '${durationInMinute.toInt()} minutes'
                                                                    : '${durationInMinute.toInt()} minutes',
                                                                style: Theme.of(context).textTheme.bodySmall?.copyWith(
                                                                    color: ColorConstants.buttonTextColor,
                                                                    fontFamily: FontWeightEnum.w700.toInter,
                                              ...
                                              children: List.generate(element.callStatusHistory?.length ?? 0, (index) {
                                                return Row(
                                                  ...
                                                  children: [
                                                    BodySmallText(
                                                        title:
                                                            element.callStatusHistory?[index].firstCreated?.to12HourTimeFormat().toUpperCase() ?? '',
                                                        fontFamily: FontWeightEnum.w400.toInter,
                                                        titleColor: ColorConstants.buttonTextColor),
                                                    10.0.spaceX,
                                                    Flexible(
