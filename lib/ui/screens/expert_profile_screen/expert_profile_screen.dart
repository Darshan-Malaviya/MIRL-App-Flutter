...
class ExpertProfileScreen extends ConsumerStatefulWidget {
 // final ScrollController scrollController;
  const ExpertProfileScreen({super.key,/* required this.scrollController*/});
...
class _ExpertProfileScreenState extends ConsumerState<ExpertProfileScreen> {
  ...
  void initState() {
    WidgetsBinding.instance.addPostFrameCallback((timeStamp) {
      ...
      ref.read(editExpertProvider).getExpertDetailApiCall(userId: SharedPrefHelper.getUserId);
    });
    super.initState();
  }
  ...
  Widget build(BuildContext context) {
    ...
    return GestureDetector(
      ...
      child: RefreshIndicator(
        ...
        onRefresh: () async {
          ref.read(editExpertProvider).getUserData();
          await expertRead.getExpertDetailApiCall(userId: SharedPrefHelper.getUserId);
        },
        child: Scaffold(
          appBar: AppBarWidget(
            appBarColor: ColorConstants.whiteColor,
            preferSize: 0,
          ),
              ...
              CustomScrollView(
                ...
                slivers: [
                  SliverAppBar(
                    ...
                    flexibleSpace: FlexibleSpaceBar(expandedTitleScale: 1.5,collapseMode: CollapseMode.pin,
                     ...
                     // controller: widget.scrollController,
                      child: Column(
                        ...
                        children: [
                          ...
                          30.0.spaceY,
                          AreaOfExpertiseWidget(areaOfExpertise: expertWatch.userData?.areaOfExpertise ?? []),
                          30.0.spaceY,
                          CertificationAndExperienceWidget(certification: expertWatch.userData?.certification ?? []),
                          ...
                          if (expertWatch.userData?.ratingCriteria?.isNotEmpty ?? false) ...[
                            ...
                            OverallRatingWidget(
                                ...
                                value: expertWatch.userData?.ratingCriteria?[4].rating ?? 0),
                          ],
