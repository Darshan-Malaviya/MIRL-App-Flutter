...
class CategoryListRepository extends ApiResponseHandler {
  ...
  Future<ApiHttpResult> categoryListApiCall({required int page, required int limit, required int isChild}) async {
    final uri = ApiConstants.endpointUri(
        path: ApiConstants.category,
        queryParameters: {"page": page.toString(), "limit": limit.toString(), "search": "", "isChild": isChild});
